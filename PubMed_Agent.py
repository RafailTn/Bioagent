...
# CREATE BASE RETRIEVER - This was missing!
...
def pubmed_search_and_store_multi_year(keywords: str, years: str = None, pnum: int = 20) -> str:
    """
...
def pubmed_search_and_store(keywords: str, year: str = None, pnum: int = 20) -> str:
...
pubmed_agent = create_react_agent(
    model=pi_llm,
    tools=tools,
